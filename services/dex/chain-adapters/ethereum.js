...
/**
 * Ethereum Chain Adapter - Handles Ethereum DEX interactions
 */
class EthereumAdapter {
  ...
  /**
   * Get all DEXes on Ethereum network
  ...
  async getAllDexes() {
    ...
    try {
      ...
      logger.error('Failed to fetch DEXes from Ethereum:', error);
      throw error;
    }
  }
  ...
  async getTradingPairsForDex(dexName, limit = 200) {
    ...
    try {
      ...
      logger.error(`Failed to fetch trading pairs for ${dexName} on Ethereum:`, error);
      throw error;
    }
  }

  /**
   * Get active trading pairs from all Ethereum DEXes
  ...
  async getActiveTradingPairs(limit = 20) {
    try {
      ...
      logger.error('Failed to fetch active trading pairs from Ethereum:', error);
      throw error;
    }
  }
  ...
  async updateAllPrices() {
    try {
      ...
      logger.error('Failed to update Ethereum prices:', error);
      throw error;
    }
  }
}

module.exports = new EthereumAdapter();
